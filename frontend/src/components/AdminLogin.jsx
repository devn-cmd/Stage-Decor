  ...
  return (
    <div style={{
      ...
      <form onSubmit={handleLogin} style={{
        background: '#0d1329', padding: '48px 40px', borderRadius: '20px',
        boxShadow: '0 8px 40px rgba(0,0,0,0.4)', width: '100%', maxWidth: '420px',
      }}>
        {/* Logo */}
        ...
        {/* Creator credit */}
        <p style={{
          textAlign: 'center', marginTop: '28px', fontSize: '0.72rem', color: '#5a6380',
          borderTop: '1px solid rgba(108, 92, 231, 0.12)', paddingTop: '16px',
        }}>
          Crafted by{' '}
          <span style={{
